...
import { FiX, FiGithub, FiInstagram } from 'react-icons/fi'; // Install react-icons jika belum: npm install react-icons
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`bg-zinc-900 border border-red-500/50 rounded-2xl shadow-2xl shadow-violet-500/20 w-full max-w-lg transform transition-transform duration-300 ${isClosing ? 'animate-out' : 'animate-in'}`}
      >
        {/* --- GAMBAR PROYEK --- */}
        <img 
          src={project.image} 
